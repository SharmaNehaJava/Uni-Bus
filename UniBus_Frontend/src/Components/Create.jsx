...
const Create = () => {
    ...
    emailjs
      .send(
        ...
        temp,
        {
          ...
          from_name: "Neha",
          receiver: `${email}@gmail.com`,//use email like this receiver: {email}
        },
        key
      )
      .then(
  ...
  return (
    <div style={styles.container2}>
      ...
      <div id = "box" style={styles.container}>
        <center><h1 style={{ paddingTop: '4px', color:"#3380D2"}}>Create Account</h1></center>
        <hr />
